...
public class NoSlow extends Module {
    ...
    public final BooleanProperty swordOnlyAutoBlock = new BooleanProperty("sword-only-autoblock", false, () -> this.swordMode.getValue() != 0);
    ...
    public boolean isSwordActive() {
        if (this.swordMode.getValue() == 0 || !ItemUtil.isHoldingSword()) {
            return false;
        }
        if (this.swordOnlyAutoBlock.getValue()) {
